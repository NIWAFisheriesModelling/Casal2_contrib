...
sim_vals_alt = read.simulated.data(dir = sim_dir_alt)
# check no trouble with files
...
DHARMaResAF = createDHARMa(simulatedResponse = sim_vals_alt$sim_obs$sim_chatTANage, observedResponse = as.numeric(mean_obs_bin), 
  fittedPredictedResponse = NULL, integerResponse = F)
